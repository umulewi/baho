...
if (!isset($_SESSION['first_name']) || !isset($_SESSION['last_name']) || !isset($_SESSION['email']) || !isset($_SESSION['phone'])) {
    // Redirect to the contact form if session data is missing
    header("Location: baho/login.php");
    exit();
}
        ...
        <div class="main">
            ...
            <div class="signup">
                <form method="POST" action="">
                    ...
                    <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($_SESSION['email']); ?>" placeholder="Email" required>

                    <input type="text" id="first_name" name="first_name" value="<?php echo htmlspecialchars($_SESSION['first_name']); ?>" placeholder="First Name" required>
                    
                   

                    <input type="text" id="last_name" name="last_name" value="<?php echo htmlspecialchars($_SESSION['last_name']); ?>" placeholder="Last Name" required>
