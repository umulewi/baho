...
$user_email = $_SESSION['user_email']; // Assign session email to $user_email
?>

<?php
include 'dashboard.php'; // Assuming this file contains necessary dashboard functionalities
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
// Query to select user data based on email
