...
if (isset($_POST["register"])) {
    ...
    try {
        ...
        $sql = "INSERT INTO job_seeker (firstname, lastname, fathers_name, mothers_name, province, district, sector, cell, village, date_of_birth, id, created_by) VALUES (:firstname, :lastname, :fathers_name, :mothers_name, :province, :district, :sector, :cell, :village, :date_of_birth, :id, :created_by)";
