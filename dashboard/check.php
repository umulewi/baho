...
<div class="form-container">
    <form action="" method="GET">
        ...
        <div class="dual-slider">
            ...
            <input type="range" id="max_salary" name="max_salary" min="0" max="100000" step="1000" value="<?php echo isset($_GET['max_salary']) ? $_GET['max_salary'] : 100000 ?>">
            <div class="output" id="min_salary_output">0</div>
            <div class="output" id="max_salary_output">100000</div>
        </div>
